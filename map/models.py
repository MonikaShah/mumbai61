...
class MumbaiBuildingsWardPrabhagwise17Jan(models.Model):
    ...
    building_name = models.CharField(max_length=254, blank=True, null=True)
    building_type = models.CharField(max_length=254, blank=True, null=True)
    is_bwg = models.CharField(max_length=254, blank=True, null=True)
    bwg_type = models.CharField(max_length=254, blank=True, null=True)
    is_compost = models.CharField(max_length=254, blank=True, null=True)
    compost_type = models.CharField(max_length=254, blank=True, null=True)
