...
urlpatterns = [
    ...
    path("aggregatorForm",views.aggregatorForm,name='aggregatorForm'),
    #path("showgroup/",views.group,name="showgroup"),
    path("aggregatorRequestorLogin",views.aggregatorRequestorLogin,name="aggregatorRequestorLogin"),
    ...
    path('show_dailystat/',views.showdailystatus_interns,name="show_dailystat"),
    path('show_dailydyna/',views.showdailydyna_interns,name="show_dailydyna"),
    path('get_marker_data/',views.get_marker_data,name="get_marker_data"),
    # path('tree_census_charts/',views.tree_census_charts, name="tree_census_charts"),
    path('garbage_seg_rev/', views.WasteSegregationDetailsRevisedView_new,name='garbage_seg_rev'),
    path('garbage_seg_rev/<str:id>', views.WasteSegregationDetailsRevisedView,name='garbage_seg_rev'),   
